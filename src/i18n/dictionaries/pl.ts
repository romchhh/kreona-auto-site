...
export const pl: Dictionary = {
  ...
  selectionPage: {
    ...
    waterLead: 'Dobieramy, kupujemy i dostarczamy jednostki pływające pod klucz.',
    oversizedLead: 'Dobieramy i wspieramy sprowadzanie techniki specjalnej.',
    types: {
      yacht: 'Jachty',
  ...
  waterPage: {
    metaTitle: 'Statki pod klucz - KREONA',
    metaDescription:
    ...
    midCtaTitle: 'Potrzebujesz jednostek pływających?',
  ...
  oversizedPage: {
    metaTitle: 'Technika specjalna pod klucz - KREONA',
    metaDescription:
