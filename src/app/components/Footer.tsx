    ...
    <footer id="site-footer" className={styles.footer}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.infoGrid}>
          <div className={`${styles.infoItem} ${styles.infoCompany}`}>
            <h3 className={styles.infoLabel}>{dict.footer.company}</h3>
            <p className={styles.infoValue}>{BRAND.name}</p>
          </div>

          <div className={`${styles.infoItem} ${styles.infoAddress}`}>
            <h3 className={styles.infoLabel}>{dict.footer.address}</h3>
            <a
              href={BRAND.mapLink}
          ...
          <div className={`${styles.infoItem} ${styles.infoPhones}`}>
            <h3 className={styles.infoLabel}>{dict.footer.phones}</h3>
            {BRAND.phones.map((phone) => (
              <div key={phone} className={styles.phoneRow}>
                <a href={`tel:${phoneTel(phone)}`} className={styles.infoValue}>
                  {phone}
                </a>
                <a
          ...
          <div className={`${styles.infoItem} ${styles.infoEmail}`}>
            <h3 className={styles.infoLabel}>{dict.footer.email}</h3>
            <a href={`mailto:${BRAND.email}`} className={styles.infoValue}>
              {BRAND.email}
            </a>
          </div>

          <div className={`${styles.infoItem} ${styles.infoInstagram}`}>
            <h3 className={styles.infoLabel}>{dict.footer.instagram}</h3>
            <a
          ...
          <div className={`${styles.infoItem} ${styles.infoVat}`}>
            <h3 className={styles.infoLabel}>{dict.footer.vat}</h3>
            <p className={styles.infoValue}>{BRAND.vat}</p>
          </div>

          <div className={`${styles.infoItem} ${styles.infoEori}`}>
            <h3 className={styles.infoLabel}>{dict.footer.eori}</h3>
            <p className={styles.infoValue}>{BRAND.eori}</p>
          </div>
        </div>
